...
require("lazy").setup({
  ...
  { -- Colorscheme. To selelct your own...
    -- Change the name of the colorscheme plugin below, and then
    -- change the command in the config to whatever the name of that colorscheme is.
    'folke/tokyonight.nvim',
    priority = 1000, -- To load this before all the other start plugins.
    init = function()
        ...
        lua_ls = {
          ...
          settings = {
            Lua = {
              ...
              -- diagnostics = { disable = { 'missing-fields' } } -- Toggle this to ignore Lua_LS's noisy `missing-fields` warnings
            },
          },
        },
      }
